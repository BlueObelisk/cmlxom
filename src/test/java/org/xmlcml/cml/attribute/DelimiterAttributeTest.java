...
public class DelimiterAttributeTest {
	...
	public final void testSetCMLValue() {
		...
		Assert.assertEquals("simple delim ", S_SLASH, delimiterAttribute
				.getConcat());
	}
	...
	public final void testDelimiterAttribute() {
		...
		Assert.assertEquals("simple delim ", S_EMPTY, delimiterAttribute
				.getCMLValue());
	...
	public final void testDelimiterAttributeString() {
		...
		Assert
				.assertEquals("delim ", S_SLASH, delimiterAttribute
						.getCMLValue());
		Assert.assertEquals("splitter ", S_SLASH, delimiterAttribute
				.getSplitter());

		delimiterAttribute = new DelimiterAttribute(S_EMPTY);
		Assert.assertEquals("concat ", S_SPACE, delimiterAttribute.getConcat());
		Assert
				.assertEquals("delim ", S_EMPTY, delimiterAttribute
						.getCMLValue());
		Assert.assertEquals("splitter ", S_WHITEREGEX, delimiterAttribute
				.getSplitter());
	...
	public final void testGetDelimitedXMLContentStringArray() {
		...
		Assert.assertEquals("concat ", S_PIPE, delimiterAttribute.getConcat());
		Assert.assertEquals("delim ", S_PIPE, delimiterAttribute.getCMLValue());
		Assert.assertEquals("splitter ", S_BACKSLASH + S_PIPE,
