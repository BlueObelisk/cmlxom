...
public class BaseTest extends EuclidTestBase implements CMLConstants {
    ...
    public static void assertEqualsIncludingFloat(
    	...
    	assertEqualsIncludingFloat(message, refNode, testNode, stripWhite, eps, true);
    }
     ...
     */
    public static void assertEqualsIncludingFloat(
    		String message, Node refNode, Node testNode, boolean stripWhite, double eps, boolean report) {
