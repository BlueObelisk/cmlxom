...
// attribute:   latticeType
    ...
    * @throws RuntimeException attribute wrong value/type
    */
    public void setLatticeType(String value) throws RuntimeException {
        StringSTAttribute att = null;
        if (_att_latticetype == null) {
            _att_latticetype = (StringSTAttribute) attributeFactory.getAttribute("latticeType", "lattice");
            if (_att_latticetype == null) {
                throw new RuntimeException("BUG: cannot process attributeGroupName : latticeType probably incompatible attributeGroupName and attributeName");
            }
        }
...
// attribute:   spaceType
    ...
    * @throws RuntimeException attribute wrong value/type
    */
    public void setSpaceType(String value) throws RuntimeException {
        StringSTAttribute att = null;
        if (_att_spacetype == null) {
            _att_spacetype = (StringSTAttribute) attributeFactory.getAttribute("spaceType", "lattice");
            if (_att_spacetype == null) {
                throw new RuntimeException("BUG: cannot process attributeGroupName : spaceType probably incompatible attributeGroupName and attributeName");
            }
        }
