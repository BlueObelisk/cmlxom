...
// attribute:   content
    ...
    */
    public void setContent(String value) throws RuntimeException {
        StringSTAttribute att = null;
        if (_att_content == null) {
            _att_content = (StringSTAttribute) attributeFactory.getAttribute("content", "metadata");
            if (_att_content == null) {
                throw new RuntimeException("BUG: cannot process attributeGroupName : content probably incompatible attributeGroupName and attributeName");
            }
        }
